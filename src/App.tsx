    ...
    assistants: [
      {
        ...
        icon: ListChecks,
        embedUrl: '/embedded/message-todo/todo-clean.html?shell=sidebar&v=20260609-todo-stream-clean',
      },
    ],
  },
  {
    ...
    assistants: [
      {
        ...
        icon: ShieldCheck,
        embedUrl: '/embedded/permission-check/index.html?shell=sidebar&v=20260609-combo-demo',
      },
      {
        name: '组织架构调整助手',
        category: '公共助手',

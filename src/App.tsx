    ...
    assistants: [
      {
        ...
        icon: ListChecks,
        embedUrl: '/embedded/message-todo/todo-clean.html?shell=sidebar&v=20260604-todo-clean-entry',
      },
    ],
  },
  {
    ...
    assistants: [
      {
        ...
        icon: FileSearch,
        embedUrl: '/embedded/document-reader/index.html?v=20260603-doc-reader-latest-sync',
      },
      {
        name: '套打助手',
        category: '公共助手',

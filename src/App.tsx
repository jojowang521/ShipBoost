    ...
    assistants: [
      {
        ...
        embedUrl: 'http://127.0.0.1:5192/?shell=sidebar',
      },
    ],
  },
  {
    ...
    assistants: [
      ...
      },
      {
        ...
        icon: GitBranch,
        embedUrl: 'http://127.0.0.1:4179/?shell=sidebar',
      },
      {
        name: '流程维护助手',
        category: '公共助手',
        ...
        icon: Workflow,
        embedUrl: 'http://127.0.0.1:5178/?shell=sidebar',
      },
    ],
  },
  {
    ...
    assistants: [
      {
        ...
        icon: ListChecks,
        embedUrl: 'http://localhost:8901/assets/payment-application-review-demo/index.html?shell=sidebar&v=20260524-local-sync2',
      },
    ],
  },
  {
    ...
    assistants: [
      {
        ...
        icon: ShieldCheck,
        embedUrl: 'http://localhost:4174/?shell=sidebar',
      },
      {
        name: '组织架构调整助手',
        category: '公共助手',

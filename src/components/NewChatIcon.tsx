    ...
    >
      <g clipPath="url(#new-chat-icon-clip)">
        <path
          ...
          strokeWidth="1.2"
        />
        <path d="M5.17169 8H10.8288" stroke="#999999" strokeWidth="1.2" strokeLinecap="round" />
        <path d="M8.00009 10.8284V5.17123" stroke="#999999" strokeWidth="1.2" strokeLinecap="round" />
      </g>
      <defs>
